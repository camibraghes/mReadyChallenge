        ...
        NavigationView {
            List {
                ForEach(repositories) { repository in
                    NavigationLink {
                        RepositoryDetailsView(repositoryDetails: repositoryDetails)
                    } label: {
...
struct RepositoriesList_Previews: PreviewProvider {
    static var previews: some View {
        ...
        ], repositoryDetails: RepositoryDetailsDisplayData(id: 1, author: "@Cami", name: "MyAwesomeRepo", url: URL(string: "https://github.com/camibraghes/SwiftUIProgress")!, stars: 230, forks: 3, watchers: 82, description: "This is the description of a hardcoded repo", readMe: "Welcome to my repo! Here you can find details about what is does, the content and purpose of it."))
    }
}
